...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/gpp-client-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/gpp-client-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install gpp-client
```
...
It is possible to list all of the versions of `gpp-client` available on your platform:
...
```
pixi search gpp-client --channel conda-forge
```
